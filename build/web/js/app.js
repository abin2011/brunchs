...
(function(/*! Stitch !*/) {
...
}).call(this)({"collections/todo_list": function(exports, require, module) {(function() {
  var Todo;
  ...
  exports.MainRouter = (function() {
    ...
    MainRouter.prototype.home = function() {
      ...
      return $('#todo-app').append(app.views.newTodoView.render().el);
    };
  ...
  exports.NewTodoView = (function() {
    ...
    NewTodoView.prototype.submit = function() {
      var _content;
      _content = this.$('#new-todo').val();
      return app.collections.todoList.add({
        content: _content
      });
    };
...
}, "views/todo_list_view": function(exports, require, module) {(function() {
  var TodoList, TodoView;
  var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; }, __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };
  ...
  exports.TodoListView = (function() {
    ...
    TodoListView.prototype.render = function() {
      ...
      this.collection.each(function(model) {
        ...
        return $el.append(_todoView.render().el);
      });
      return this;
    };

    TodoListView.prototype.addOne = function(model) {
      var $el, _todoView;
      $el = this.$(this.el);
      _todoView = new TodoView({
        model: model
  ...
  exports.TodoView = (function() {
    ...
    TodoView.prototype.render = function() {
      this.$(this.el).html(todoTemplate(this.model.toJSON()));
      return this;
    };
